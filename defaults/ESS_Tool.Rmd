...
TerrADat <- RODBC::sqlQuery(conn, 'SELECT * FROM ilmocAIMTerrestrialPub.ilmocAIMPubDBO.TerrestrialIndicators_evw;')

Species_Indicator <- RODBC::sqlQuery(conn, 'SELECT * FROM ilmocAIMTerrestrialPub.ilmocAIMPubDBO.TerrestrialSpecies;')

SpeciesList <- RODBC::sqlQuery(conn, 'SELECT * FROM ilmocAIMTerrestrialPub.ILMOCAIMPUBDBO.tblStateSpecies_evw;')
}
```
