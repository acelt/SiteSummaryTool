...
MakeMap(EcologicalSiteId = unique(TDat_LMF_Attributed$EcologicalSiteId), TDat_LMF_Attributed)

```

## Some metadata {.tabset .tabset-fade .tabset-pills}

### Plots Per Time Period and Ecological Site in your Study Area(s) {.tabset .tabset-fade .tabset-pills}
...
```{r plots figure 3 , echo = FALSE, fig.height = 3 , fig.width = 8, fig.cap = "AIM & LMF Plots Per Year in Piceance-East Douglas HMA"}
...
EcologicalSiteIds_AF <- subset(EcologicalSiteIds, EcologicalSiteIds != "Dry Exposure" & EcologicalSiteIds != "Loamy Slopes" & EcologicalSiteIds != "Brushy Loam")
...
```{r CI summaryfigures, echo=FALSE, message=FALSE, include=FALSE}
...
####
#### Perennial Forb {.tabset .tabset-fade .tabset-pills}

```{r CI SFG plots grass static, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  message(i)
  #print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_PerenForbCover"]])
  print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_PerenForbCover"]])
  cat("  \n")
}
...
#### Perennial Grass {.tabset .tabset-fade .tabset-pills}

```{r CI SFG plots forb static, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_PerenGrassCover"]])
  plot(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_PerenGrassCover"]])
  cat("  \n")
}

```

#### Non-Noxious Annual Forbs {.tabset .tabset-fade .tabset-pills}

```{r CI nn af plots  static, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_NonNoxAnnForbCover"]])
  plot(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_NonNoxAnnForbCover"]])
  cat("  \n")
}

```

#### Short Perennial Grass Cover {.tabset .tabset-fade .tabset-pills}

Short Stature Perennial Grasses status was determined by Sage
Grouse biologists and modified slightly in each state. The full list can be found in tblStateSpecies in the
SG_Group field where SG_Group field is ‘TallStaturePerennialGrass’ and the StateSpecies field has
the two letter state code for the desired state (e.g. ‘CO’).
...
```{r CI short pg plots  static, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_ShortPerenGrassCover"]])
  plot(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_ShortPerenGrassCover"]])
  cat("  \n")
}

```

#### Tall Perennial Grass Cover {.tabset .tabset-fade .tabset-pills}

Tall Stature Perennial Grasses status was determined by Sage Grouse
biologist and modified slightly in each state. The full list can be found in tblStateSpecies in the
SG_Group field where SG_Group field is ‘TallStaturePerennialGrass’ and the StateSpecies field has
the two letter state code for the desired state (e.g. ‘CO’).

These inlcude: ACHY, AGCR, BRIN2, ELEL5, FEID, HECO26, KOMA, PASM, PLJA, PSSP6, SPAI, SPCR, THIN6 etc.

```{r CI tall pg plots  static, fig.height = 5 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_TallPerenGrassCover"]])
  plot(CI_FigureList_stat[[i]][["GrowthHabitSub"]][["AH_TallPerenGrassCover"]])
  cat("  \n")
}
...
```{r CI nox plots static , fig.height = 6 , fig.width = 10 , echo = FALSE, include = TRUE, message=FALSE, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Noxious"]])
  plot(CI_FigureList_stat[[i]][["Noxious"]])
  cat("  \n")
}
...
#### Graminoid, Annual {.tabset .tabset-fade .tabset-pills}
#####
```{r CI species plots grass annual static , fig.height = 10 , fig.width = 10 , echo = FALSE, include = TRUE , results = 'asis', message=FALSE}

EcologicalSiteIds_AG <- subset(EcologicalSiteIds, EcologicalSiteIds != "Dry Exposure")

for(i in EcologicalSiteIds_AG){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Species"]][["Graminoid.Annual"]])
  plot(CI_FigureList_stat[[i]][["Species"]][["Graminoid.Annual"]])
  cat("  \n")
}
...
#### Graminoid, Perennial {.tabset .tabset-fade .tabset-pills}
#####
```{r CI species plots grass perennial static, fig.height = 14 , fig.width = 10 , echo = FALSE, include = TRUE , results = 'asis', message=FALSE}

for(i in EcologicalSiteIds){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Species"]][["Graminoid.Perennial"]])
  plot(CI_FigureList_stat[[i]][["Species"]][["Graminoid.Perennial"]])
  cat("  \n")
}
...
#### Forb, Annual {.tabset .tabset-fade .tabset-pills}
#####
```{r CI species plots forb annual static , fig.height = 14 , fig.width = 10 , echo = FALSE, include = TRUE , results = 'asis', message=FALSE}

EcologicalSiteIds_AF <- subset(EcologicalSiteIds, EcologicalSiteIds != "Loamy Slopes" & EcologicalSiteIds != "Brushy Loam")

for(i in EcologicalSiteIds_AF){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Species"]][["Forb.Annual"]])
  plot(CI_FigureList_stat[[i]][["Species"]][["Forb.Annual"]])
  cat("  \n")
}
...
#### Forb, Perennial {.tabset .tabset-fade .tabset-pills}
#####
```{r CI species plots forb perennial static, fig.height = 14 , fig.width = 10 , echo = FALSE, include = TRUE , results = 'asis', message=FALSE}

EcologicalSiteIds_PF <- EcologicalSiteIds[EcologicalSiteIds!="R034BY297CO"]

for(i in EcologicalSiteIds_PF){
  cat("  \n#####", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Species"]][["Forb.Perennial"]])
  plot(CI_FigureList_stat[[i]][["Species"]][["Forb.Perennial"]])
  cat("  \n")
}
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed,
                             Species_plots_ecosite = Species_plots_ecosite,
                             SummaryVar = "Species",
                             SummarizeBy = "Plot",
                             Attributed_Pks = Attributed_Pks)
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "Species", 
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "GrowthHabitSub", 
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "Noxious", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks)
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "Woody", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks)
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "TraceSpecies", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks) 
...
###
```{r CI LPI ground plot static , echo = FALSE ,  fig.height = 10 , fig.width = 10 ,  results = 'asis', message=FALSE, include=TRUE}

for(i in EcologicalSiteIds){
  cat("  \n###", i, "  \n")
  #print(CI_FigureList_stat[[i]][["GroundCover"]])
  plot(CI_FigureList_stat[[i]][["GroundCover"]])
  cat("  \n")
}
```
##
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "GroundCover", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks)
...
## Confidence Interval Figure  {.tabset .tabset-fade .tabset-pills}
###
```{r CI Gap plot static , echo = FALSE , include = TRUE , fig.height = 16, fig.width= 10, results="asis"}

for(i in EcologicalSiteIds){
  cat("  \n###", i, "  \n")
  #print(CI_FigureList_stat[[i]][["Gap"]])
  plot(CI_FigureList_stat[[i]][["Gap"]])
  cat("  \n")
}
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "Gap", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks)
...
## Confidence Interval Figure {.tabset .tabset-fade .tabset-pills}
###
```{r CI soil stab plot static , echo = FALSE , include = TRUE , fig.height = 8 , fig.width = 10, results="asis", message=FALSE}

for(i in EcologicalSiteIds){
  cat("  \n###", i, "  \n")
  #print(CI_FigureList_stat[[i]][["SoilStability"]])
  plot(CI_FigureList_stat[[i]][["SoilStability"]])
  cat("  \n")
}
...
SummaryTables_WithAttributes(EcoSitePlots = TDat_LMF_Attributed, Species_plots_ecosite, SummaryVar = "SoilStability", 
              SummarizeBy = "Plot", Attributed_Pks = Attributed_Pks)
...
###
### Figure
```{r, echo=FALSE, include=TRUE, fig.height = 8 , fig.width = 14}
plotly::ggplotly(p)%>%
...
rap_data <-  read.csv("C:\\Users\\alaurencetraynor\\Documents\\2021\\Analysis\\CO\\WHFO\\HMA\\PED_HMA_RAP.csv")

mk_test <- apply(X = rap_data[,2:6],
              MARGIN = 2,
              FUN = function(x){
                test <- Kendall::MannKendall(x)
                return(test)
                })
  
ss_test <- apply(X = rap_data[,2:6],
              MARGIN = 2,
              FUN = function(x){
                test <- trend::sens.slope(x, conf.level = 0.8)
                return(test)
              })

# library(gdalUtils)
# gdalUtils::gdal_translate(of="GTiff", co="TILED=YES", src_dataset="/vsicurl/http://rangeland.ntsg.umt.edu/data/rap/rap-vegetation-cover/v2/vegetation-cover-v2-2019.tif", projwin=(c(-118.01, 43.42, -116.7, 42.8)), output_Raster=TRUE, dst_dataset="seOR2019-rap.tif")
...
for(i in EcologicalSiteIds){
  tests[[i]] <- t.tests(TDat_LMF_Attributed = TDat_LMF_Attributed,
                        EcologicalSite = i,
                        alpha = 0.2)
}
...
###
```{r t test tables, echo = FALSE , include = TRUE, results="asis", message=FALSE}

for(i in EcologicalSiteIds){
  cat("  \n###", i, "  \n")
  #print(tests[[i]])
  print( htmltools::tagList(tests[[i]]))
  cat("  \n")
}
